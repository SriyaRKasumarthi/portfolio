  ...
  return (
    ...
    >
            ...
            <div className="max-w-4xl mx-auto text-left">
              ...
              <div className="mb-8">
                ...
                <div className="bg-white/5 rounded-xl p-8 border border-white/10 mb-8">
                  ...
                  <div className="w-full rounded-lg overflow-hidden">
                    <img
                      src={`${import.meta.env.BASE_URL}images/projects/oasis/competitiveanalysis.png`}
        ...
        <>
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <motion.a
                  href={`${import.meta.env.BASE_URL}images/projects/robotic-gestures/Robotics Augmented Web Conferencing.docx.pdf`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-8 py-4 bg-beige-500 text-white font-medium rounded-xl border-2 border-beige-400 overflow-hidden shadow-lg hover:shadow-2xl hover:border-beige-300 transition-all duration-500 cursor-hover group"
                  whileHover={{
      ...
      <VideoModal
        ...
        videoSrc={`${import.meta.env.BASE_URL}images/projects/robotic-gestures/Testing.MOV`}
