...
const __TWEAKS_STYLE = `
  ...
  .tweaks-fab{
    ...
    border:.5px solid rgba(26,22,18,.12);background:rgba(251,247,237,.9);
    color:#1a1612;font:600 14px/1 ui-serif,Georgia,serif;cursor:pointer;
    box-shadow:0 8px 24px rgba(0,0,0,.12);backdrop-filter:blur(8px);
  }
  .tweaks-fab:hover{background:rgba(255,255,255,.95)}
`;
